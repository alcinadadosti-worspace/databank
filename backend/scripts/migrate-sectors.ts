...
const SECTOR_MAP: Record<number, { sector: string; parent_leader_id: number | null }> = {
  // Alta Lideranca (4 diretores)
  1:  { sector: 'Alta Lideranca', parent_leader_id: null },       // Romulo Lisboa - Gerente Canal VD
  6:  { sector: 'Alta Lideranca', parent_leader_id: null },       // Leidiane Souza - Gerente Canal Loja
  8:  { sector: 'Alta Lideranca', parent_leader_id: null },       // Leidiane Souza (duplicate)
  13: { sector: 'Alta Lideranca', parent_leader_id: null },       // Michaell Jean Nunes De Carvalho
  14: { sector: 'Alta Lideranca', parent_leader_id: null },       // Rafaela Mendes

  // Logistica
  2:  { sector: 'Logistica', parent_leader_id: null },            // Alberto Luiz Marinho Batista

  // VD Penedo (sob Romulo)
  3:  { sector: 'VD Penedo', parent_leader_id: 1 },              // Joao Antonio Tavares Santos

  // VD Palmeira dos Indios (sob Romulo)
